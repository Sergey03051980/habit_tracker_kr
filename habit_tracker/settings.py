...
INSTALLED_APPS = [
    ...
    'django_extensions',
    'habit_tracker.apps.users',
    'habit_tracker.apps.habits',
    'habit_tracker.apps.telegram_bot',
]
...
# ВАЖНО: Используем SQLite для надежности, но конфиг PostgreSQL оставлен
...
# Папки со статикой для разработки
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
...
# Для разработки - отладочный режим
DEBUG = True
